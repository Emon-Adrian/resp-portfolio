        ...
        <div className="skills">
            ...
            <div className="content">
               <div>
                   ...
                   <p>In my persue to become a full stack Dev, I had earlier choosen python as my first backend language. I know a few basics of Python and I can't wait to carry on soon and learn django to improve my Web Dev skills</p>
               </div>
            </div>
            <div className="content">
               <div>
